...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic21lYjEyIiwiYSI6ImNsMDd5Y2JhYTB4eGYzaW81eHFqcmEyOXIifQ.rkrm2jZMXfsmHLdWiI8wiQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', _context.t0.response.data.message.replace('passwordConfirm', '') // userModel ang gumawa ng error
            );
...
var stripe = Stripe('pk_test_51Kb2VXLntuHNBcqX967cZaDX7TBuSjJwZ1nZVcuI9sogqrjbQYJCMCXm4v0WjISun32NsMKGIHyRTi6bed9sEHf3001j6goNj9'); // async function myAsyncFunction() {
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _signup.signup)(name, email, passwordConfirm, password);
});
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm').value; // await para matapos yung functions na async at para magawa yung mga event after nung function
