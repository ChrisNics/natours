...
exports.resizeTourImages = catchAsync(async (req, res, next) => {
  ...
  // 2) Images
  // yung async/await nasa loob lang ng map kaya need Promise.all
  await Promise.all(
...
exports.getTour = factory.getOne(Tour, { path: 'reviews' }); // Medyo confusing kase gumana kahit 'reviews' lang ilagay HAHAHA
